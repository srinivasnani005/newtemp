...
telegram_username = "Contact admin @Edit Engineer" 
...
def read_me(chatid):
    readme = f'''Welcome to Edit Engineer Bot. Here are some clarifications\n\n
...
def privacy(chatid):
    privacy = f'''Welcome to Edit Engineer. Our privacy policy\n\n
...
def terms(chatid):
    terms = f'''Welcome to Edit Engineer Bot. Terms of use\n\n
